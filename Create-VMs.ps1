...
$vmList = @(
#     @{ Name = "king-sys-prod-dns-01"; IP = "192.168.137.11/24"; Cores = "1"; Memory = "1" },
#     @{ Name = "king-sys-prod-dns-02"; IP = "192.168.137.12/24"; Cores = "1"; Memory = "1" },
#     @{ Name = "king-sys-prod-chrony"; IP = "192.168.137.13/24"; Cores = "1"; Memory = "1" },
#     @{ Name = "king-sys-prod-nginx"; IP = "192.168.137.14/24"; Cores = "1"; Memory = "2" },
#     @{ Name = "king-sys-prod-postgresql"; IP = "192.168.137.15/24"; Cores = "2"; Memory = "4" }
#     @{ Name = "king-sys-prod-mysql"; IP = "192.168.137.6/14"; Cores = "2"; Memory = "4" },
